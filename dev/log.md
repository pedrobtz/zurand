# zurand roadmap history

The roadmap as it stood from 2026-09-19 to 2026-09-25, kept verbatim below
the line: the original phases, both amendments, the memory-traffic and SIMD
measurements, and the proposed revision. `dev/roadmap.md` and
`dev/design.md` replaced it on 2026-09-25; item numbers used there
(1.2, 3.1, 5.2 ...) refer to this document.

---

## zurand roadmap (as of 2026-09-25)
